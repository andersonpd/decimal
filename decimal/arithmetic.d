...
// READY: isCanonical
/**
 * Returns true if the number has a canonical representation (always true).
 */
public bool isCanonical(const Decimal num) {
	return num.isCanonical;
}
 ...
 */
public bool isSignaling(const Decimal num) {
	return num.isSignaling;
}
 ...
 */
public bool isQuiet(const Decimal num) {
	return num.isQuiet;
}

// READY: isFinite
/**
 * Returns true if the number is a finite, i.e., neither infinite nor NaN.
 */
public bool isFinite(const Decimal num) {
	return num.isFinite;
}
 ...
 */
public bool isInfinite(const Decimal num) {
	return num.isInfinite;
}

// READY: isNaN
/**
 * Returns true if the number is a NaN (quiet or signaling).
 */
public bool isNaN(const Decimal num) {
	return num.isNaN;
}

// READY: isNormal
/**
 * Returns true if the number is finite and not subnormal.
 */
public bool isNormal(const Decimal num) {
	return num.isNormal;
}

// READY: isSubnormal
/**
 * Returns true if the number is finite and subnormal.
 */
public bool isSubnormal(const Decimal num) {
	return num.isSubnormal;
}

// READY: isZero
/**
 * Returns true if the number is +zero or -zero.
 */
public bool isZero(const Decimal num) {
	return num.isZero;
}

// READY: isSigned
/**
 * Returns true if the number is negative i.e., its sign flag is set.
 */
public bool isSigned(const Decimal num) {
	return num.sign;
}
